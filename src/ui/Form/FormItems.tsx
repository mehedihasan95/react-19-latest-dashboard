...
// FORM ITEM INPUT
export const FormItemInputUi = createFormItem<
  Record<string, unknown>,
  GetProps<typeof Input>
>(Input, { span: 24 });

// FORM ITEM PASSWORD
export const FormItemPasswordUi = createFormItem<
  Record<string, unknown>,
  GetProps<typeof Input.Password>
>(Input.Password, { span: 24 });

// FORM ITEM TEXT AREA
export const FormItemTextareaUi = createFormItem<
  Record<string, unknown>,
  GetProps<typeof Input.TextArea>
>(Input.TextArea, { span: 24 });

// FORM ITEM INPUT NUMBER
export const FormItemInputNumberUi = createFormItem<
  Record<string, unknown>,
...
// FORM ITEM INPUT OTP
export const FormItemInputOTPUi = createFormItem<
  Record<string, unknown>,
  GetProps<typeof Input.OTP>
>(Input.OTP, { span: 24 });

// FORM ITEM INPUT RADIO
export const FormItemRadioGroupUi = createFormItem<
  Record<string, unknown>,
  GetProps<typeof Radio.Group>
>(Radio.Group, { span: 24 });

// FORM ITEM SELECT
export const FormItemSelectUi = createFormItem<
  Record<string, unknown>,
...
export const FormItemDatePickerUi = createFormItem<
  Record<string, unknown>,
...
export const FormItemDatePickerRangeUi = createFormItem<
  Record<string, unknown>,
